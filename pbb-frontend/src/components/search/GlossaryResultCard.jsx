const GlossaryResultCard = ({ result, searchTerm }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-200 p-4 md:p-5 border border-slate-200 hover:border-blue-300 group">
      {/* Term Header */}
      <div className="mb-2 md:mb-3">
        ...
        {result.book_name && (
          <div className="flex items-center mt-1.5 md:mt-2 space-x-2">
            ...
            <span className="text-xs md:text-sm font-semibold text-blue-600">{result.book_name}</span>
          </div>
        )}
      </div>
      ...
      {result.description && (
        <div className="mt-2 md:mt-3">
          <p className="text-slate-700 leading-relaxed text-sm md:text-sm">
