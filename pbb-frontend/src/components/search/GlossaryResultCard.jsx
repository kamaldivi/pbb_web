const GlossaryResultCard = ({ result, searchTerm }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-200 p-5 border border-slate-200 hover:border-blue-300 group">
      {/* Term Header */}
      <div className="mb-3">
        ...
        {result.book_name && (
          <div className="flex items-center mt-2 space-x-2">
            ...
            <span className="text-sm font-semibold text-blue-600">{result.book_name}</span>
          </div>
        )}
      </div>
