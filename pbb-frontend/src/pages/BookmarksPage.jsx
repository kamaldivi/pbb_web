...
const BookmarksPage = () => {
  ...
  const handleNavigateToBookmark = (bookmark) => {
    // Default to english tab when returning from bookmarks
    navigate(`/reader?book_id=${bookmark.bookId}&page=${bookmark.pageNumber}&return_tab=english`);
  };
              ...
              <div className="p-5">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold rounded-lg transition-all border border-blue-200 hover:border-blue-300"
                  >
                    Open
                  </button>
                  <button
                    onClick={() => handleDelete(bookmark.id)}
                    className="px-4 py-2 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all border border-slate-200 hover:border-red-300"
