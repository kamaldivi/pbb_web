...
const GlossarySearchPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {/* Results Section */}
      {hasSearched && (
        <div className="bg-gradient-to-br from-purple-50/80 via-indigo-50/60 to-blue-50/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-purple-200/50">
          {/* Results Header */}
          {!loading && !error && (
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {['Bhakti', 'Krishna', 'Prema', 'Dharma', 'Yoga', 'Mantra'].map((term) => (
                  <button
                    ...
                    className="px-4 py-2 bg-white border border-purple-200 rounded-lg text-sm font-medium text-purple-700 hover:bg-purple-50 hover:border-purple-300 transition-all duration-200"
                  >
                    {term}
                  </button>
                ))}
